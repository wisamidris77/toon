...
void main() {
  group('primitives', () {
    ...
    test('treats unquoted invalid numeric formats as strings', () {
      ...
      expect(toonDecode('nums[3]: 05,007,0123'), equals({'nums': ['05', '007', '0123']}));
    });
  ...
  group('objects (simple)', () {
    test('parses objects with primitive values', () {
      const toon = 'id: 123\nname: Ada\nactive: true';
      expect(toonDecode(toon), equals({'id': 123, 'name': 'Ada', 'active': true}));
    });
    ...
    test('parses quoted object values with special characters and escapes', () {
      ...
      expect(toonDecode('text: "say \\"hello\\""'), equals({'text': 'say "hello"'}));
  ...
  group('arrays (primitive)', () {
    test('parses inline primitive arrays', () {
      expect(toonDecode('nums[3]: 1,2,3'), equals({'nums': [1, 2, 3]}));
      expect(toonDecode('flags[2]: true,false'), equals({'flags': [true, false]}));
      expect(toonDecode('data[3]: hello,world,test'), equals({'data': ['hello', 'world', 'test']}));
    });
  ...
  group('arrays (tabular)', () {
    ...
    test('parses tabular arrays with mixed types', () {
      const toon = 'data[2]{name,count,active}:\n  Alice,42,true\n  Bob,17,false';
      expect(toonDecode(toon), equals({
        'data': [
  ...
  group('arrays (list)', () {
    test('parses list arrays of primitives', () {
      ...
      expect(toonDecode(toon), equals({'numbers': [1, 2, 3]}));
    });
